...
bootbox.confirm("¿Desea registrar Evento?<br/> Nota: los datos mal ingresados no seran regitrados.", function(result) {

if (result==true) 
{


     $.post(page_root + "buscar", $("#frmeventos").values(), function(data) {
