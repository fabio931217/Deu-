...
var msj1="En registrar asamblea:";
...
bootbox.confirm("¿Desea registrar asamblea?<br/> Nota: los datos mal ingresados no seran regitrados.", function(result) {

if (result==true) 
{


     $.post(page_root + "buscar", $("#frmasamblea").values(), function(data) {
