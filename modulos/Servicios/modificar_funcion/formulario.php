...
if (result==true) 
{
        $.post(page_root + "guardar_modificacion", $("#funcion").values(), function(data) {
            //alert(data);
            var r = jQuery.parseJSON(data);
            if (r.error == true)
            {
    ...
    <form id="formulario" method="POST">
        <table style="width:100%">
            ...
            <tr  class="ui-state-active" style="height:24px">
                <th colspan="3">Modificar Funcion</th>
            </tr>
 ...
 <table width="80%"  id="reporte" name="reporte" align="center" style="margin-top:20px;border-radius:12px " class="bordered">
  <thead>
        ...
        <tr>
            ...
            <th width="40%" style="border-radius: 0px 8px 8px 0px;width:5px">Funcion <select id="combo_todo" onChange="combos()" style="width:77%">';
...
echo "<tr>
            ...
            <td>$rw[fecha_hora]</td>
            <td> <select name='cbmfuncion[]' class='combo' style='width:90%';padding:20px;>";

$rs=$db->query("SELECT * FROM funcion"); 
