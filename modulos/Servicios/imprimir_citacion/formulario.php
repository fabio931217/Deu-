...
<a class="items" style="width:600px; margin:auto; margin-top:10px;margin-bottom:10px">
    <div class="icono">
        <img src="img/iconos/citacion.png" alt="" style="width:90px" />
    </div>
    <div class="texto">
        <span style="text-align:left">Imprimir citacion</span>
        <div>Desde esta opci&oacuten podrá imprimir todas las citaciones que tenga en varios formatos.</div>
    </div>
</a> 
    ...
    <form id="formulario" method="post"  target="_blank" 
        ...
        <table style="width:100%">
            <tr  class="ui-state-active" style="height:24px">
                <th colspan="3">Imprimir Citacion</th>
            </tr>

            <tr> 
                <td class="tdi">Citacion</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <select id="txtbuscar" name="txtbuscar" title="Citacion" Class="chosen-select">
                        <?php
