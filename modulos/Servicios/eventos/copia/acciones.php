...
class Formulario extends Base {
    function validar() {
        $v = new Validation($_POST);
		 $v->addRules('cbmevento', 'Buscar Evento', array('required' => true) );
...
LIMIT 100";
    ...
    function buscar() {
        ...
        $r['tabla']= '<tr>
            ...
            <td>nombre2</td>
            <td>tipo2</td>
            <td class="ocultar">$descripcion 2 </td>
            <td class="ocultar">$objetivo 2</td>
...
FROM agenda a, persona p, escenario e
...
$tema=$rw['tema'];
   ...
   <tr  style=\"color:#fff;text-align:center;font-size:13px;background-color:#004000;\">
                   ...
                   <th colspan=\"3\"> AGENDA NUMERO: $no </th>              
                  </tr>
                    <tr  style=\"color:#000;text-align:center;font-size:12px;\">
