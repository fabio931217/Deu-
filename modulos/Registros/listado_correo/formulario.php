    ...
    <form class="div-form-busqueda ui-dialog-content ui-widget-content" id="form-busqueda">
        <div style="width:100%; margin:auto">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bnombre" name="nombre" title="Nombre" maxlength="30" value="" />
                </td>            
            </tr> 
    ...
    <form id="formulario">
        <table style="width:100%">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="nombre" name="nombre" title="Nombre" maxlength="30" value="" />
                <input type="hidden" id="cod_persona" name="cod_persona" title="Id" maxlength="11" value="<?php echo $_SESSION['persona_id']  ?>"  class="no-modificable"/>
