...
<div  style="width:900px; margin:auto; margin-top:20px;margin-bottom:20px">
   
        <table style="width:100%">

            <tr  class="ui-state-active" style="height:24px">
                <th colspan="3">Asamblea</th>
            </tr>
...
<script type="text/javascript" src="jquery-te-1.4.0.min.js" charset="utf-8"></script>
  ...
  require_once("modulos/Registros/asamblea/asamblea.php");
...
$( "#dialog" ).dialog({
  ...
  <div id="dialog" title="Tenga en cuenta los siguientes datos">
    ...
    <div style="border:none;padding:8px; border-radius:8px;box-shadow:0px 0px 12px;margin-top:8px; width:100%;height:100%">
