        ...
        grid = $.addGrid("#grid",
                {
                    ...
                    cols: [
						...
						{display: 'CONVERSION', name: 'conversion', width: 200, align: 'left'}
                    ]}
        );
...
<div>
    ...
    <form class="div-form-busqueda ui-dialog-content ui-widget-content" id="form-busqueda">
        <div style="width:100%; margin:auto">
            ...
            <tr> 
                <td class="tdi">Conversion</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bconversion" name="conversion" title="Conversion" maxlength="40" value="" />
                </td>            
            </tr>
            </table>
            <div class="acciones"> 
    ...
    <form id="formulario">
        <table style="width:100%">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="conversion" name="conversion" title="Conversion" maxlength="40" value="" />
                </td>            
            </tr>
