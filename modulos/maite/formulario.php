    ...
    <form id="formulario">
        <table style="width:100%">
            ...
            <tr  class="ui-state-active" style="height:24px">
                <th colspan="3">Maite</th>
            </tr>
 

            <tr> 
                <td class="tdi">cbmepoort</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <select id="cbmreporte" name="cbmreporte" title="cbmepoort">
                        <?php
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                 <input type="text" name="txt" id="txt"  value="" title="Fabio" maxlength="30"/>
                </td>            
            </tr>
