    ...
    <form class="div-form-busqueda ui-dialog-content ui-widget-content" id="form-busqueda">
        <div style="width:100%; margin:auto">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bnombre" name="nombre" title="Nombre" maxlength="60" value="" />
                </td>            
            </tr> 
            <tr>
                <td class="tdi">Departamento id</td>
                <td class="tdc">:</td>
                <td class="tdd">
                	<select id="bdepartamento_id" name="departamento_id" title="Departamento id">
                    	<?php llenar_combo("SELECT id, nombre FROM departamento ORDER BY nombre",true); ?>
                    </select>                
                </td>
            </tr>
            </table>
    ...
    <form id="formulario">
        <table style="width:100%">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="nombre" name="nombre" title="Nombre" maxlength="60" value="" />
                </td>            
            </tr> 
            <tr>
                <td class="tdi">Departamento id</td>
                <td class="tdc">:</td>
                <td class="tdd">
                	<select id="departamento_id" name="departamento_id" title="Departamento id">
                    	<?php llenar_combo("SELECT id, nombre FROM departamento ORDER BY nombre",true); ?>
                    </select>                
                </td>
            </tr>
