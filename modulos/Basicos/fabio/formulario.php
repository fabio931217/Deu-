...
<div  style="width:600px; margin:auto; margin-top:20px">
    <form id="formulario">
        <table style="width:100%">
            ...
            <tr> 
                <td class="tdi">txt2</td>
                <td class="tdc">:</td>
                <td class="tdd">
                 <input type="text" name="txt2" id="txt2"  value="" title="txt2" maxlength="30"/>
                </td>            
            </tr>

            <tr> 
                <td class="tdi">txt1</td>
                <td class="tdc">:</td>
                <td class="tdd">
                 <input type="text" name="txt1" id="txt1"  value="" title="txt1" maxlength="30"/>
                </td>            
            </tr>

            <tr> 
                <td class="tdi">txt3</td>
                <td class="tdc">:</td>
                <td class="tdd">
                    <select id="txt3" name="txt3" title="txt3">
                        <?php
